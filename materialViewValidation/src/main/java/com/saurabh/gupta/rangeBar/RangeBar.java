...
public class RangeBar extends View {
    ...
    private static final float DEFAULT_CENTER_CIRCLE_BOUNDARY_SIZE_DP = 0;
    ...
    private int mThumbCenterPointColor = DEFAULT_CONNECTING_LINE_COLOR;

    private float mThumbBoundarySize = DEFAULT_CIRCLE_BOUNDARY_SIZE_DP;

    private float mThumbCenterPointSize = DEFAULT_CENTER_CIRCLE_BOUNDARY_SIZE_DP;
    ...
    private int mActiveThumbCenterPointColor;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (mIsRangeBar) {
            ...
            mLeftThumb.init(ctx, yPos, expandedPinRadius, mPinColor, mTextColor, mThumbSize,
                    mThumbColorLeft, mThumbBoundaryColor, mThumbCenterPointColor, mThumbBoundarySize, mThumbCenterPointSize, mMinPinFont, mMaxPinFont, mArePinsTemporary);
        }
        ...
        mRightThumb.init(ctx, yPos, expandedPinRadius, mPinColor, mTextColor, mThumbSize,
                mThumbColorRight, mThumbBoundaryColor, mThumbCenterPointColor, mThumbBoundarySize, mThumbCenterPointSize, mMinPinFont, mMaxPinFont, mArePinsTemporary);
     ...
     */
    public void setThumbCenterPointColor(int thumbCenterPointColor) {
     ...
     *                          Value should be in DP
     */
    public void setThumbCenterPointSize(int thumbCenterPointSize) {
        mThumbCenterPointSize = thumbCenterPointSize;
        createPins();
    }
    ...
    private void rangeBarInit(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mThumbCenterPointSize = ta.getDimension(R.styleable.RangeBar_mrb_thumbCenterPointSize,
                    TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_CENTER_CIRCLE_BOUNDARY_SIZE_DP,
                            mDisplayMetrices)
            );
            ...
            mThumbBoundaryColor = ta.getColor(R.styleable.RangeBar_mrb_thumbBoundaryColor,
                    DEFAULT_CONNECTING_LINE_COLOR);
            mThumbCenterPointColor = ta.getColor(R.styleable.RangeBar_mrb_thumbCenterPointColor,
                    DEFAULT_CONNECTING_LINE_COLOR);
    ...
    private void createPins() {
        ...
        if (mIsRangeBar) {
            mLeftThumb = new PinView(ctx);
            mLeftThumb.init(ctx, yPos, expandedPinRadius, mPinColor, mTextColor, mThumbSize, mThumbColorLeft, mThumbBoundaryColor, mThumbCenterPointColor, mThumbBoundarySize, mThumbCenterPointSize,
                    mMinPinFont, mMaxPinFont, mArePinsTemporary);
        }
        mRightThumb = new PinView(ctx);
        mRightThumb
                .init(ctx, yPos, expandedPinRadius, mPinColor, mTextColor, mThumbSize, mThumbColorRight, mThumbBoundaryColor, mThumbCenterPointColor, mThumbBoundarySize, mThumbCenterPointSize
                        , mMinPinFont, mMaxPinFont, mArePinsTemporary);
