...
class PinView extends View {
    ...
    private float mCenterCirclePointRadiusPx;
    ...
    public void init(Context ctx, float y, float pinRadiusDP, int pinColor, int textColor,
                     float circleRadius, int circleColor, int circleBoundaryColor, int centerPointColor, float circleBoundarySize, float centerCirclePointSize, float minFont, float maxFont, boolean pinsAreTemporary) {
        ...
        if (centerCirclePointSize != 0) {
            mCenterCirclePaint = new Paint();
            mCenterCirclePaint.setStyle(Paint.Style.FILL);
            mCenterCirclePaint.setColor(centerPointColor);
            mCenterCirclePaint.setStrokeWidth(centerCirclePointSize);
    ...
    public void draw(Canvas canvas) {
        ...
        if (mCenterCirclePaint != null)
            canvas.drawCircle(mX, mY, mCenterCirclePointRadiusPx, mCenterCirclePaint);
