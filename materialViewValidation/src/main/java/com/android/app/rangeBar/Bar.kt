...
class Bar(
    ...
    fun drawTicks(
        ...
        pinRadius: Float,
        rightThumb: PinView?,
        leftThumb: PinView? = null
    ) {
        var paintLabel = false
        if (mLabelPaint != null) {
            paintLabel = true
            val textSize = TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_SP, mTickLabelSize,
                mRes.displayMetrics
            ).toInt()
        ...
        for (i in 0 until mNumSegments) {
            ...
            if (paintLabel) {
                if (mTickTopLabels != null) drawTickLabel(
                    canvas,
                    getTickTopLabel(i),
                    x,
                    pinRadius,
                ...
                if (mTickBottomLabels != null) drawTickLabel(
                    canvas,
                    getTickBottomLabel(i),
                    x,
                    pinRadius,
                    i == 0,
                    false,
        ...
        if (paintLabel) {
            ...
            if (mTickBottomLabels != null) drawTickLabel(
                canvas,
                getTickBottomLabel(mNumSegments),
                rightX,
                pinRadius,
                false,
                true,
